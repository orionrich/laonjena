...
document.addEventListener('DOMContentLoaded', function () {
  ...
  video.playbackRate = 0.55; // 55% 속도로 재생
});
...
const products10 = [
  {
    img: product1Image,
    title: '여성 변형플리츠 옆트임 롱기장 큐롯',
    desc: '우아하게 떨어지는 변형 플리츠 디자인이 특징 세련된 옆트임으로 여성스러운 라인을 강조합니다.',
    salePrice: '29,000',
  ...
  },
  {
    img: product2Image,
    title: '여성 져지 플레어 큐롯',
    desc: '편안한 져지 소재 다리 라인을 우아하게 연출하며, 다양한 탑과 쉽게 매치할 수 있습니다.',
    salePrice: '34,000',
  ...
  {
    img: product3Image,
    title: '트리밍 데님 플리츠 랩 스커트 - 블루',
    desc: '세련된 트리밍 디테일과 데님 소재의 조화로 독특한 스타일을 자랑합니다. ',
    salePrice: '29,000',
    originalPrice: '42,000',
    link: 'javascript:void(0);',
  },
  {
    img: product4Image,
    title: '퍼플 카라 타이 밴딩 원피스',
    desc: ' 눈에 띄는 퍼플 컬러와 클래식한 카라 디테일이 특징입니다.',
    salePrice: '59,000',
  ...
  },
  {
    img: product5Image,
    title: '핑크 집업 플레어 원피스',
    desc: '상큼한 핑크 컬러에 집업 디자인이 돋보이는 여성스러운 플레어 원피스입니다.',
    salePrice: '15,000',
  ...
  {
    img: product6Image,
    title: '써지컬스틸 스틱 체인 목걸이',
    desc: '내구성 있는 써지컬스틸로 만들어진, 세련된 스틱 디자인의 체인 목걸이입니다.',
    salePrice: '29,000',
    originalPrice: '42,000',
    link: 'javascript:void(0);',
  },
  {
    img: product7Image,
    title: '피스마크 심볼 브레이슬릿-아이보리',
    desc: '아이보리 컬러에 평화의 심볼이 특징인 고급 브레이슬릿입니다.',
    salePrice: '19,000',
  ...
  {
    img: product8Image,
    title: '링바 레이어드 슬림 가죽팔찌',
    desc: '링 디테일이 돋보이는 레이어드 스타일의 슬림한 가죽 팔찌입니다.',
    salePrice: '15,000',
...
const products20 = [
  {
    img: product9Image,
    title: '23FW 까나쥬 퀼팅 스커트',
    desc: '23년 가을/겨울 컬렉션의 까나쥬 브랜드 특유의 따뜻한 퀼팅 디테일이 특징인 스커트입니다.',
    salePrice: '69,000',
  ...
  {
    img: product10Image,
    title: '로맨틱 플리츠 체크 스커트 - 브라운',
    desc: '로맨틱한 무드의 플리츠 디테일과 체크 패턴이 조화로운 브라운 컬러 스커트입니다.',
    salePrice: '24,000',
  ...
  {
    img: product11Image,
    title: '우먼즈 데님 미디 스커트 [워시드 블랙]',
    desc: '여성을 위한 워시드 블랙 컬러의 데님 미디 스커트로, 빈티지한 무드가 돋보입니다.',
    salePrice: '21,000',
  ...
  },
  {
    img: product12Image,
    title: '사이드 배색 니트 스커트',
    desc: '사이드에 세련된 배색 디테일이 포인트인 니트 소재의 스커트입니다.',
    salePrice: '21,000',
    originalPrice: '25,000',
    link: 'javascript:void(0);',
  },
  {
    img: product13Image,
    title: '하프 문 백_2컬러',
    desc: '반달 모양의 독특한 디자인과 두 가지 컬러 옵션이 특징인 스타일리시한 백입니다.',
    salePrice: '129,000',
  ...
  },
  {
    img: product14Image,
    title: '비건가죽 램번트 숄더백',
    desc: '동물친화적인 비건 가죽으로 제작된, 램번트 텍스처의 고급스러운 숄더백입니다.',
    salePrice: '59,000',
  ...
  },
  {
    img: product15Image,
    title: '리프 클로버 브로치 실버',
    desc: '클로버 모양의 세련된 디자인과 은색 소재가 돋보이는 우아한 브로치입니다.',
    salePrice: '19,000',
  ...
  {
    img: product16Image,
    title: '오디너리 베이직 다이아몬드 커플 반지(플랫 슬림)',
    desc: '심플한 디자인의 플랫 슬림 형태에 섬세한 다이아몬드가 장식된 커플을 위한 우아한 반지입니다.',
    salePrice: '29,000',
    originalPrice: '42,000',
    link: 'javascript:void(0);',
  },
